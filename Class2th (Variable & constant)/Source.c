...
#pragma region (2)진수를 (10)진수로 변환하는 과정
	...
	// 각각의 비트에 1이 있다면 1고아 2의 제곱의 위치를 계산한
	// 다음에 각각의 비트를 모두 더하여 10진수로 나타냅니다.
#pragma endregion
...
#pragma region AND 연산자
	...
	//                    //-----------
	//                       0000 1101
	//int a = wisdom & dexterity;
	//printf("%d ", a);

#pragma endregion

#pragma region OR 연산자
	// 두 개의 피연산자 중에 하나라도 1이 있다면 1을 봔환하는 연산자입니다.
...
#pragma region 시프트 연산자
	// 비트를 특정한 위치로 정해진 수만큼 이동시키는 연산자입니다.
	    // <<2 왼쪽 2컨 이동
	//int packtet = 5;    // 0000 0101 -> 0001 0010 
	//printf("packtet 변수를 왼쪽으로 2칸 이동한 결과 : %d\n", packtet << 2);
	//printf("packtet 변수를 오른쪽으로 1칸 이동한 결과 : %d\n", packtet >> 1);
